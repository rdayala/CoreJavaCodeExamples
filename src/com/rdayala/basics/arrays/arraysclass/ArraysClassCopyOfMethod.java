...
public class ArraysClassCopyOfMethod {
	...
	public static void main(String[] args) {
		...
		System.out.println(Arrays.toString(i1)); // Output : [1, 21, 15, 48, 79,
													// 0, 0, 0, 0, 0]
		...
		System.out.println(Arrays.toString(d1)); // Output : [12.5, 45.8, 56.2,
													// 47.9]
		...
		System.out.println(Arrays.toString(bln1)); // Output : [true, false,
