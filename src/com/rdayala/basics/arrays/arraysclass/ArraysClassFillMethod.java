package com.rdayala.basics.arrays.arraysclass;

import java.util.Arrays;

public class ArraysClassFillMethod {
	...
	public static void main(String[] args) {
		...
		System.out.println(Arrays.toString(d)); // Output : [53.6, 53.6, 53.6,
												// 53.6]
		...
		System.out.println(Arrays.toString(bln)); // Output : [true, true, true,
													// true, true]
		...
		System.out.println(Arrays.toString(c)); // Output : [P, P, P, P, P, P,
												// P, P, P, P]
		...
		System.out.println(Arrays.toString(str)); // Output : [value, value,
													// value, value]
	}
