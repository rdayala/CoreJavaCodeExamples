package com.rdayala.datetime.legacybeforejava8;
...
public class DateTimeDemo {
	...
	private static void testLegacyDateAPI() {
		...
		System.out.println("\nDate class ... ");
		// Date class encapsulate both date and time information -> mysql data
		// type : DATETIME
		Date currentDate = new Date();
		System.out.println("currentDate(default 24hrs format): " + currentDate);
		System.out.println("currentDate in ms: " + currentDate.getTime());

		// ---------------------------------------------------------
		System.out.println("\nCalendar class ... ");
		Calendar expiryDate = new GregorianCalendar(2017, 05, 30);
		System.out.println("expiryDate obj: " + expiryDate);
